...
public class Pizzaoptiondata {
    ...
    public Pizzaoptiondata() {
    }

    public Pizzaoptiondata(String category, String multilinedes, String puniqueid, String subheading, String pname, int pprice, String pimg, boolean isShrink) {
