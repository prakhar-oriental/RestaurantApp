...
public class Donutoptiondata {
    ...
    public Donutoptiondata() {

    }

    public Donutoptiondata(String category, String multilinedes, String puniqueid, String subheading, String pname, int pprice, String pimg, boolean isShrink) {
