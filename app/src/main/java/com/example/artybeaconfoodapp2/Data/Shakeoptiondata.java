...
public class Shakeoptiondata {
    ...
    public Shakeoptiondata() {
    }

    public Shakeoptiondata(String category, String multilinedes, String puniqueid, String subheading, String pname, int pprice, String pimg, boolean isShrink) {
